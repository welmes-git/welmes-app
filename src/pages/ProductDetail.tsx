                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-end gap-0">
                          <button
                            onClick={() => changeQty(opt.id, -1)}
                            disabled={!canSeePrice}
                            className="w-7 h-7 border border-[#ddd] flex items-center justify-center rounded-l hover:bg-[#f0f0f0] disabled:opacity-30"
                          >
                            <Minus size={11} />
                          </button>
                          <span className="w-9 h-7 border-t border-b border-[#ddd] flex items-center justify-center text-[13px] font-medium">
                            {qty}
                          </span>
                          <button
                            onClick={() => changeQty(opt.id, 1)}
                            disabled={!canSeePrice}
                            className="w-7 h-7 border border-[#ddd] flex items-center justify-center rounded-r hover:bg-[#f0f0f0] disabled:opacity-30"
                          >
                            <Plus size={11} />
                          </button>
                        </div>
